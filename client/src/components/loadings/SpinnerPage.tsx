...
import LogoSicnew from '@/assets/images/image-logo/logo_seadragon_noname_w506-h506.webp';
...
//     center no-repeat; */
//   background: url('../../images/image-logo/logo_seadragon_w127-h127.webp')
//     center no-repeat;
...
export function SpinnerPage() {
  return (
    <>
      <Overlay />
      <Container>
        <ImageLoading src={LogoSicnew} alt='Logo Company' />
        <SpinnerLoading />
      </Container>
    </>
  );
